...
function d = controller(x, z)
    ...
    Kstate = [ ...
    0.0654653864006679  -0.0274927323962088 -0.454516598156748  0.135026207306818   0.000793840258830838    0.00626392375077485 -0.00187689533208575    -0.00467812252167444    0.000631663906848940;...
    -0.000970216492528531   -0.00111644853391061    0.00764913097756127 -0.00358596903080962    -0.420600454776221  -6.18389723587504   1.83339161252354    0.317400060221916   -0.0427580325557285;...
];

    Kref = [ ...
    4.37896390524257e-07    2.02292922419949e-07;...
    3.76338197238553e-07    3.27975143305982e-07;...
];
    d = (-[Kstate Kref]*[x3d; z])';
end
